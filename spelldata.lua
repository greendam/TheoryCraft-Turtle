...
TheoryCraft_Talents = {
	...
	{ class="MAGE", name="impae", bonustype="Arcanecritchance", tree=1, number=8, perrank=2 },
	{ class="MAGE", name="meditation", bonustype="ICPercent", tree=1, number=13, firstrank=0.06, perrank=0.07 },
	{ class="MAGE", name="potency", bonustype="Arcanecritbonus", tree=1, number=17, perrank=0.25 },
	...
	{ class="MAGE", name="critmass", bonustype="Firecritchance", tree=2, number=14, perrank=2 },
	{ class="MAGE", name="firepower", bonustype="Firemodifier", tree=2, number=16, perrank=0.02 },
	...
	{ class="MAGE", name="piercice", bonustype="Frostmodifier", tree=3, number=4, perrank=0.02 },
	{ class="MAGE", name="shards", bonustype="Frostcritbonus", tree=3, number=8, perrank=0.1 },
	...
	{ class="MAGE", name="shatter", bonustype="Allshatter", tree=3, number=13, perrank=7 },
	...
	{ class="WARLOCK", name="impcorrupt", bonustype="Corruptioncasttime", tree=1, number=2, perrank=-0.3, forceonly=1 },
	{ class="WARLOCK", name="impdrainlife", bonustype="Drain Lifemodifier", tree=1, number=6, perrank=0.05 },
	{ class="WARLOCK", name="impcoa", bonustype="Curse of Agonymodifier", tree=1, number=9, firstrank=0.3, perrank=0.035 },
	{ class="WARLOCK", name="shadowmastery", bonustype="Shadowmodifier", tree=1, number=16, perrank=0.02 },
	{ class="WARLOCK", name="demonicembrace", bonustype="stammultiplier", tree=2, number=2, perrank=0.03 },
	{ class="WARLOCK", name="demonicembrace", bonustype="spiritmultiplier", tree=2, number=2, perrank=-0.01, dontlist=1 },
	{ class="WARLOCK", name="devastation", bonustype="Destructioncritchance", tree=3, number=8, perrank=1 },
	{ class="WARLOCK", name="impsearing", bonustype="Searing Paincritchance", tree=3, number=11, perrank=2 },
	{ class="WARLOCK", name="impimmolate", bonustype="ImmolateUpFrontmodifier", tree=3, number=13, perrank=0.04 },
	...
	{ class="PRIEST", name="imppwrword", bonustype="Power Word: Shieldmodifier", tree=1, number=10, perrank=0.05 },
	{ class="PRIEST", name="pmeditation", bonustype="ICPercent", tree=1, number=11, perrank=0.05 },
	{ class="PRIEST", name="mentalagility", bonustype="MentalAgilitymanacost", tree=1, number=3, perrank=-0.02, forceonly=1 },
	{ class="PRIEST", name="purflames", bonustype="Damagemodifier", tree=1, number=13, perrank=0.12, forceonly=1 },
	{ class="PRIEST", name="mentalstrength", bonustype="intmultiplier", tree=1, number=14, perrank=0.03 },
	{ class="PRIEST", name="enlighten", bonustype="Damagemodifier", tree=1, number=15, perrank=0.12, forceonly=1 },
	{ class="PRIEST", name="enlighten", bonustype="Healingmodifier", tree=1, number=15, perrank=0.12, forceonly=1 },
	{ class="PRIEST", name="forceofwill", bonustype="Damagemodifier", tree=1, number=17, perrank=0.01 },
	...
	{ class="PALADIN", name="improvedright", bonustype="Seal of Righteousnessmodifier", tree=1, number=5, perrank=0.02 },
	{ class="PALADIN", name="healinglight", bonustype="Healingmodifier", tree=1, number=6, perrank=0.04 },
	{ class="PALADIN", name="illumination", bonustype="Holyillum", tree=1, number=9, perrank=0.2 },
	--{ class="PALADIN", name="ironclad", bonustype="Allarmor", tree=1, number=12, perrank=0.3 },
	{ class="PALADIN", name="ironclad", bonustype="Allarmor", tree=1, number=12, perrank=1 },
	{ class="PALADIN", name="divinefavor", bonustype="Holy Shockcritchance", tree=1, number=13, perrank=10 },
	{ class="PALADIN", name="holypower", bonustype="Holy Lightcritchance", tree=1, number=15, perrank=2, forceonly=1 },
	{ class="PALADIN", name="holypower", bonustype="Flash of Lightcritchance", tree=1, number=15, perrank=2, forceonly=1, dontlist=1 },
	{ class="PALADIN", name="onehandspec", bonustype="Onehandmodifier", tree=2, number=14, perrank=0.02 },
	{ class="PALADIN", name="righteous", bonustype="Holy Strikemodifier", tree=2, number=15, perrank=0.05 },
...
TheoryCraft_Spells = {
	["MAGE"] = {
		...
		{ id="Arcane Missiles", level1=8, level1manamult=1/3, level2=16, level2manamult=1/4, percent=0.286, dodps=1, manamultiplier=1/5, cancrit=1, casttime=1, regencasttime=1, tickinterval=1,
			Schools={ "All", "Damage", "Arcane" } },
...
--			Schools={ } },
	...
	["PRIEST"] = {
		{ id="Prayer of Healing", isheal=1, percent=3/3.5/3*0.85, dodps=1, cancrit=1, prayerofhealing=1, talentsbeforegear=1,
		...
		{ id="Mind Flay", percent=0.75, dodps=1, casttime=3, regencasttime=3,
			Schools={ "All", "Damage", "Shadow", } },
		{ id="Mind Blast", level1=10, level2=16, percent=0.6, dodps=1, cancrit=1, dontdomax=1,
			Schools={ "All", "Damage", "Shadow" } },
		...
		{ id="Holy Fire", percent=0.857, percentdot=0.263, dodps=1, cancrit=1, hasdot=1,
			Schools={ "All", "Damage", "Holy", "Divinefury", "SearingLight" } },
		{ id="Holy Nova", percent=0.161, percentheal=0.11, dodps=1, cancrit=1, holynova=1,
		...
		{ id="Desperate Prayer", isheal=1, percent=1.5/3.5*0.85, dodps=1, dontdomax=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy" } },
		{ id="Lesser Heal", level1=1, level1per=2.1/3.5*0.85, level2=4, level2per=2.9/3.5, level3=10, percent=2.51/3.5, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy", "ImpHealing" } },
		{ id="Heal", level1=16, percent=3/3.5*0.85, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy", "Divinefury", "ImpHealing" } },
		{ id="Flash Heal", percent=1.5/3.5*0.85, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy" } },
		{ id="Greater Heal", percent=3/3.5*0.85, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy", "Divinefury", "ImpHealing" } },
		{ id="Devouring Plague", binary=1, percent=1/2, isdot=1, dodps=1, basedotduration=24, dontdomax=1,
			Schools={ "All", "Damage", "Shadow", "MentalAgility" } },
		{ id="Renew", level1=8, level2=14, percent=0.85, dodps=1, isheal=1, basedotduration=15, dontdomax=1, isdot=1, talentsbeforegear=1,
	...
	["WARRIOR"] = {
		...
		{ id="Shield Slam", cancrit=1, armor=1, ismelee=1, forcemult=2.2,
			Schools={ "Melee" } },
		{ id="Rend", cancrit=1, ismelee=1, rend=1, --forcemult=2.2,
			Schools={ "Melee" } },
	...
	["PALADIN"] = {
		{ id="Flash of Light", percent=1.5/3.5, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy" } },
		{ id="Crusader Strike", ismelee=1, percent=0.33, cancrit=1, armor=1,
			Schools={ "Melee", "Holy" } },
		{ id="Holy Strike", percent=0.43, cancrit=1, usemelee=1, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Bulwark of the Righteous", percent=0.1, usemelee=1, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Blessing of Sanctuary", percent=0.05, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Holy Shield", percent=0.14, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Holy Light", level1=1, level2=6, level3=24, percent=3/3.5, isheal=1, dodps=1, cancrit=1, talentsbeforegear=1,
			Schools={ "All", "Healing", "Holy" } },
		...
		{ id="Holy Wrath", percent=2/3.5/3, dodps=1, cancrit=1, aoe=1, dontdomax=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Consecration", level1=12, level2=22, level3=43, percent=0.56, dodps=1, aoe=1, basedotduration=8, dontdomax=1, isdot=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Hammer of Wrath", percent=1/3.5, dodps=1, dontdomax=1, cancrit=1, usemelee=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Seal of Command", isseal=1, percent=1.5/3.5, percentdot=1.5/3.5/2, hasdot=1, command=1, dodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Seal of Righteousness", isseal=1, percent=0.5, percent2=0.5, percentdot=0.728, hasdot=1, righteousness=1, dodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Holy Shock", percentheal=1.5/3.5, cancrit=1, holynova=1, dontdomax=1, dodps=1,
			Schools={ "All", "Healing", "Holy" } },
