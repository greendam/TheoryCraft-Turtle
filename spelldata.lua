...
--			Schools={ } },
	...
	["PALADIN"] = {
		...
		{ id="Bulwark of the Righteous", percent=0.1, usemelee=1, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Blessing of Sanctuary", percent=0.1, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Holy Shield", percent=0.05, dontdomax=1, dontdodps=1,
			Schools={ "All", "Damage", "Holy" } },
		...
		{ id="Holy Wrath", percent=2/3.5/3, dodps=1, cancrit=1, aoe=1, dontdomax=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Consecration", percent=0.33, dodps=1, aoe=1, basedotduration=8, dontdomax=1, isdot=1,
			Schools={ "All", "Damage", "Holy" } },
