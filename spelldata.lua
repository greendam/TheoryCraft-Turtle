...
TheoryCraft_Talents = {
	...
	{ class="WARRIOR", name="impclap", bonustype="Thunderclapmodifier", tree=1, number=6, perrank=0.2 },
...
--			Schools={ } },
	...
	["WARRIOR"] = {
		...
		{ id="Shield Slam", cancrit=1, armor=1, ismelee=1, forcemult=2.2,
			Schools={ "Melee" } },
		{ id="Rend", cancrit=0, armor=1, ismelee=1,
			Schools={ "Melee" } },
	...
	["PALADIN"] = {
		...
		{ id="Holy Wrath", percent=2/3.5/3, dodps=1, cancrit=1, aoe=1, dontdomax=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Consecration", percent=0.952, dodps=1, aoe=1, basedotduration=8, dontdomax=1, isdot=1,
			Schools={ "All", "Damage", "Holy" } },
		...
		{ id="Seal of Command", isseal=1, percent=1.5/3.5, percentdot=1.5/3.5/2, hasdot=1, command=1, dodps=1,
			Schools={ "All", "Damage", "Holy" } },
		{ id="Seal of Righteousness", isseal=1, percent=0.1, percent2=0.12, percentdot=0.728, hasdot=1, righteousness=1, dodps=1,
			Schools={ "All", "Damage", "Holy" } },
